...
Then, we will demonstrate how these steps can be simplified using `TidyMultitude`.
...
For the TidyMultitude workflow, we will need a `MultiAssayExperiment` object containing `SummarizedExperiment` objects representing the cytokine and 16S rRNA data, respectively.
